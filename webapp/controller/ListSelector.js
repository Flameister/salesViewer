sap.ui.define([
		...
		return BaseObject.extend("salesviewer.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias salesviewer.model.ListSelector
			 */
			 ...
			 * @return {salesviewer.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
